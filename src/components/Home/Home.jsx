...
const Home = () => {
    return (
        <div className="h-screen">
            <div className="flex flex-col justify-center items-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-300 to-gray-400 lg:h-[75%] h-screen ">
                <div className="items-center justify-around mt-12 flex px-12 w-full">
                    <div className="translate-y-4 flex flex-col w-full  justify-center">
                        <h1 className="lg:text-7xl text-9xl texts-5xl text-center font-bold">
                            Teodor Marinov
                            <span
                        ...
                        <div className="flex flex-col lg:flex-row gap-10 ml-10 justify-center items-center text-gray-100 w-full -translate-x-12 lg:translate-y-2 translate-y-6">
