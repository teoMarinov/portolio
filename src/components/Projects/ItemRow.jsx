        ...
        <div>
            <div className={clsx('flex items-center justify-around md:gap-y-8 flex-col', reverse ? 'lg:flex-row-reverse' : 'lg:flex-row')}>
                <div className="w-96 text-center">
                    <h1 className='flex items-center justify-center 2xl:text-7xl xl:text-6xl lg:text-5xl md:4xl sm:text-6xl text-3xl font-poppins font-light lg:mb-0 mb-5'>{headline}</h1>
                </div>
