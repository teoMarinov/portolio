...
const Button = ({ text, open, setOpen, textColor }) => {
    return (
        <button onClick={() => setOpen(text)} className={clsx(`group font-poppins p-3 text-lg rounded-md text-${textColor} text-lgtransition-all`)}>
